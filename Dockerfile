...
RUN sudo dnf -y update 1> /dev/null
RUN sudo dnf -y install wget nano mc php epel-release git wget curl 1> /dev/null
RUN sudo dnf config-manager --enable crb 1> /dev/null
RUN sudo dnf group -y install "Development Tools" 1> /dev/null \ 
